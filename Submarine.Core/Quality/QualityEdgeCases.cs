...
namespace Submarine.Core.Quality
{
	...
	{
		/// <summary>
		/// These are default Qualities of groups which do not add there Quality in the Release Group, these will only be used if no quality is explicitly mentioned in the release
		/// </summary>
