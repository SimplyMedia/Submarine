...
/// <summary>
///     Validates Torrent Releases to not be Hashed or else invalid
/// </summary>
public class TorrentReleaseValidatorService : IValidator<string>
{
	...
	private readonly ILogger<TorrentReleaseValidatorService> _logger;

	/// <summary>
	///     Creates a new <see cref="TorrentReleaseValidatorService" /> instance
	/// </summary>
	/// <param name="logger">logger of this instance</param>
	public TorrentReleaseValidatorService(ILogger<TorrentReleaseValidatorService> logger)
		=> _logger = logger;
