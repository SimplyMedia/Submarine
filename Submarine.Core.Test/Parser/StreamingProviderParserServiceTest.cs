...
namespace Submarine.Core.Test.Parser
{
	public class StreamingProviderParserServiceTest
	{
		...
		[InlineData("[Golumpa] Anime Title S2 - 03 (100-man no Inochi no Ue ni Ore wa Tatteiru S2) [English Dub] [CR-Dub 1080p x264 AAC] [MKV] [C229250A]")]
		...
		[Theory]
		[InlineData("[Golumpa] Anime Title - The Ouka Ninja Scrolls - 17 (Basilisk - Ouka Ninpouchou) [English Dub] [FuniDub 720p x264 AAC] [MKV] [22327EE2]")]
